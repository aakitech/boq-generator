...
Tracking outreach to QS professionals and construction industry contacts for BOQ Generator.
Updated as conversations progress. 181 Tier 1 contacts (QS/estimators) identified from LinkedIn export.

**Status:** `[ ]` not contacted · `[x]` message sent · `[~]` replied · `[★]` call done
...
- [ ] Unathi Matoti (PrQS, MRICS) — Cost Manager, Turner & Townsend
- [ ] Zack Bezuidenhout — Estimator Roads & Earthworks, WBHO Construction
- [ ] Denelle Vandayar — Candidate QS, SPD Quantity Surveyors *(same firm as Ngoako — ask him for intro)*
- [ ] Brandon Saraiva — Senior QS, GVK-Siya Zama Building Contractors
- [ ] Chad Dunnett — QS, Improvon
- [ ] Gawie van Huyssteen — QS, Haaks Quantity Surveyors
- [ ] Lize Claassens — QS, Rider Levett Bucknall (ZA)
- [ ] Mulunde Ramathuba — Candidate QS, Rider Levett Bucknall
- [ ] Anthony Byebwa — Senior QS, VEA Group
- [ ] Sandiso Lubisi — QS, R&B Civils
- [ ] Mfumo Mkhabele — QS, B&W Instrumentation and Electrical
- [ ] Zifisozethu Moyo — MEP Cost Manager, Imara Grato
- [ ] Valerie Chauke (MAIQS, PMP) — QS, R. Davis & Co / Bitumen World Mining
- [ ] Kumbirai Mufandaedza — QS, Total Highway Maintenance
...
### Ngoako Sefoko
- **Email:** ngoakosef@gmail.com
- **Status:** Call done 2026-05-22
- **Notes:** 32-min call. Manual pricing from drawings confirmed as painful. Pricing "not a lot of an ask" vs WinQS (R5,000+, dongle). WinQS is dominant SA competitor — expect "why is yours better?" in every SA meeting. SA has no gazetted rates — key sources: AECOM Africa Cost Guide, ASAQS, Stats SA indices. Firms keep BOQ data private. Product link shared. Potential in-person Joburg meeting.
...
- **Company:** MTHABANE CIVILS AND PLANT
- **Status:** not contacted
- **Message:**
> Hi Ndoumesour, I've been building an AI-powered BOQ generation tool for the African construction market — upload drawings and a scope, get a structured, rated BOQ in about 10 minutes. Your background in estimating at Mthabane made me think you'd have a sharp opinion on whether this is actually useful or just another tool that sounds good in a pitch. Would you be open to a quick look and honest feedback?

### Andreas Jordaan
- **Title:** Professional Quantity Surveyor (Freelance)
- **Status:** not contacted
- **Message:**
> Hi Andreas, I'm building a BOQ generation tool for the SA construction market — AI reads your SoW and drawings and produces a structured, rated BOQ in around 10 minutes. As a freelance QS you're probably pricing jobs without a large team behind you, which is exactly the gap this is meant to fill. Would love your honest take on whether the output is credible to a professional. Happy to do a quick demo.

### Binaica Dalpat (PrQS, MRICS)
- **Title:** Senior Quantity Surveyor
- **Company:** The Project Company — Mining and Infrastructure
- **Status:** not contacted
- **Message:**
> Hi Binaica, I'm building an AI-powered BOQ tool for the African construction market — SoW and drawings in, structured rated BOQ out in about 10 minutes. Mining and infrastructure projects are exactly the kind of complex, multi-discipline scope where manual take-off is most time-consuming. Would value your perspective as a Senior QS on whether the output holds up to professional scrutiny. Open to a quick demo if you're curious.

### Unathi Matoti (PrQS, MRICS)
- **Title:** Cost Manager
- **Company:** Turner & Townsend
- **Status:** not contacted
- **Message:**
> Hi Unathi, I'm building a BOQ generation tool for the African construction market — upload a SoW and drawings, get a structured rated BOQ in about 10 minutes. Given your cost management work at Turner & Townsend, I'd be genuinely interested in your view on where AI-assisted BOQ prep fits (or doesn't fit) into how a firm like yours actually operates. No pitch — just a conversation if you're open to it.

### Zack Bezuidenhout
- **Title:** Estimator: Roads & Earthworks
- **Company:** WBHO Construction
- **Status:** not contacted
- **Message:**
> Hi Zack, I'm building an AI-powered estimating tool for the construction market — upload project drawings and scope, get a structured priced BOQ in about 10 minutes. Roads and earthworks is one of the areas our rate library is thinnest, which means your feedback would actually shape the product. Would you be open to a quick look?

### Denelle Vandayar
- **Title:** Candidate Quantity Surveyor
- **Company:** SPD Quantity Surveyors
- **Status:** not contacted — *ask Ngoako for intro first*
- **Message:**
